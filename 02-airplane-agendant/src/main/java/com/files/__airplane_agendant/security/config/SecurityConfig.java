package com.files.__airplane_agendant.security.config;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http.csrf(requets -> requets.disable())
                .authorizeHttpRequests(requets -> requets.requestMatchers("/api/auth/**")
